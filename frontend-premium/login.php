...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn { width: 100%; display: flex; align-items: center; justify-content: center; gap: 10px; padding: 14px 24px; background: var(--accent-primary); border: none; border-radius: var(--radius-md); color: #000; font-size: 14px; font-weight: 600; cursor: pointer; transition: background 0.2s; }
...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="auth-footer">Don't have an account? <a href="signup.php" class="link">Sign up</a></div>
        </div>
        <div class="features">
            <div class="feature">
